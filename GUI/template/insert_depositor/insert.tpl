...
  			</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"></label>
				<div style="display: flex; padding-right: 11px;" class="col-sm-10">
					<input style="display: inline-block; width: 75%;" class="form-control" name="city" placeholder="<?=$city_text?>" type="text" required>
					<input style="display: inline-block; width: 24%; align-self: flex-end; margin-left: 5px;" class="form-control" name="index" placeholder="<?=$index_text?>" type="number" required>
				</div>
			</div>
			<br>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div style="display: flex; padding-right: 11px;" class="col-sm-10">
					<input style="display: inline-block; width: 40%; margin-right: 15px;" class="form-control" name="document" placeholder="<?=$document_no_text?>" type="text" required>
 					<label class="radio-inline">
  						<input type="radio" name="document_type" value="id" required> <?=$id_card_text?>
					</label>
					<label class="radio-inline">
  						<input type="radio" name="document_type" value="drivers_license" required> <?=$drivers_license_text?>
					</label>
					<label class="radio-inline">
  						<input type="radio" name="document_type" value="passport" required> <?=$passport_text?>
					</label>
				</div>
			</div>
			<br>
			...
			<div class="form-group">
				...
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default">
						<input type="radio" name="available" value="true" required> <?=$yes_text?>
					</label>
					<label class="btn btn-default">
						<input type="radio" name="available" value="false" required> <?=$no_text?>
					</label>
				</div>
			</div>
			<br>
