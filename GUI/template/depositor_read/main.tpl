	...
	<div class="panel-body">
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div style="display: flex; padding-right: 11px;" class="col-sm-10">
					<p style="display: inline-block; width: 50%;" class="form-control-static"><b><?=$depositor['place of birth']?></b></p>
					<p style="display: inline-block; width: 49%; align-self: flex-end; margin-left: 5px;" class="form-control-static"><b><?=$depositor['date of birth']?></b></p>
				</div>
			</div>
			<div class="form-group">
